...
Refinery::Resources.configure do |config|
  ...
  # config.dragonfly_secret = "b282b16725e771e9526c2646118e55f780600719ff1eb609"
  # config.dragonfly_url_format = "/system/resources/:job/:basename.:format"
  # config.dragonfly_url_host = ""
  # config.datastore_root_path = "/Users/orleviteh/googledrive/Google Drive/a -parsons projects/Web Jamie/ruby/rickrockstar/public/system/refinery/resources"
