...
Refinery::Resources.configure do |config|
  ...
  # config.dragonfly_secret = "9d6f1f19d3d243e2fa1aa094d89ef6baffee014ff608c225"
  # config.dragonfly_url_format = "/system/resources/:job/:basename.:format"
  # config.dragonfly_url_host = ""
  # config.datastore_root_path = "/Users/orleviteh/rickrockstar/public/system/refinery/resources"
