...
Refinery::Resources.configure do |config|
  ...
  # config.dragonfly_secret = "49e4a3f319049e79e27102d01a45ede61949b2bf770fb398"
  # config.dragonfly_url_format = "/system/resources/:job/:basename.:format"
  # config.datastore_root_path = "/Users/Samantha/Development/code/stunable-blog/public/system/refinery/resources"
